...
include "../controls/upload_image.php";
?>
...
<!DOCTYPE html>
    ...
    <body>
        ...
        <form name="update_form" method="POST" aciton="" enctype="multipart/form-data">
            <div class="right_panel">
                ...
                <div class="dp_upload_box">
                    <img src="uploads/<?php echo $imageName; ?>" name="dp" id="dp" class="image_box">
                    <input type="file" name="file">
                    <input type="submit" name="submit" value="Submit" class="custom_button primary">
                    <p class="error_msg" id="upload_error"><?php echo $error_msg; ?></p>
                </div>
            </div> 
        </form> 
    </body>
